  export const sideNodes = [
      ...
      "to unlock potential, fostering inclusive spaces where the next generation of gamers can grow not just as players, but as students, leaders, and innovators." },
    {
      ...
      " Our funding model ensures that every dollar supports impactful programming—from building state-of-the-art gaming hubs to training mentors, " + 
    ...
    { id: 3, title: "🧩 Programs", content: "At Next Gen Arena, we believe gaming is more than a pastime—it’s a launchpad. Our programs are designed to meet youth " + 
      ...
      ,
      {
        ...
        title: "👥 Team",
        content:
          "Next Gen Arena will be led by a passionate team of educators, industry professionals, mental health advocates, and seasoned gamers—" +
